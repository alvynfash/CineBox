...
MovieResult movieSectionFromJson(String str) {
  final jsonData = json.decode(str);
  return MovieResult.fromJson(jsonData);
}

String movieSectionToJson(MovieResult data) {
...
// enum OriginalLanguage { EN, JA, PT }
